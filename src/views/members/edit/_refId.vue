...
onMounted(async () => {
  ...
  form.firstName = memberStore.getMemberDetails && memberStore.getMemberDetails.firstName ? memberStore.getMemberDetails.firstName : ''
  form.lastName = memberStore.getMemberDetails && memberStore.getMemberDetails.lastName ? memberStore.getMemberDetails.lastName : ''
  form.email = memberStore.getMemberDetails && memberStore.getMemberDetails.email ? memberStore.getMemberDetails.email : ''
  form.idNumber = memberStore.getMemberDetails && memberStore.getMemberDetails.idNumber ? memberStore.getMemberDetails.idNumber : ''
  form.phoneNumber = memberStore.getMemberDetails && memberStore.getMemberDetails.phoneNumber ? memberStore.getMemberDetails.phoneNumber : ''
  form.availableAmount = memberStore.getMemberDetails && memberStore.getMemberDetails.availableAmount ? `${memberStore.getMemberDetails.availableAmount}` : ''
  form.totalDeposits = memberStore.getMemberDetails && memberStore.getMemberDetails.totalDeposits ? `${memberStore.getMemberDetails.totalDeposits}` : ''
  form.totalShares = memberStore.getMemberDetails && memberStore.getMemberDetails.totalShares ? `${memberStore.getMemberDetails.totalShares}` : ''
})
...
const submitMember = async () => {
  ...
  if (result && confirm(`You are about to modify member:${memberStore.getMemberDetails?.memberNumber} details`)) {
    ...
    memberStore.editMemberDetails(payload, `${route.params.refId}`).then(() => router.push('/members')).then(() => authStore.defineNotification({
