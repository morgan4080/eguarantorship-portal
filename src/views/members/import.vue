      ...
      <div class="py-16">
        <div class="mx-auto max-w-7xl space-y-6 sm:px-6 lg:px-5">
          ...
          <div class="bg-white px-4 py-5 shadow sm:rounded-lg sm:px-6">
            <div class="py-5">
              <h3 class="text-lg font-medium leading-6 text-gray-900">Member Bulk Import</h3>
              ...
              <div class="flex flex-1 items-stretch overflow-hidden">
                <main class="flex-1 overflow-y-auto">
                  <section aria-labelledby="primary-heading" class="flex h-full min-w-0 flex-1 flex-col lg:order-last">
                    <div id="dragBox" @drop="dropHandler" @dragover="handleDragOver" @dragleave="handleDragLeave" @dragenter="handleDragEnter" class="flex max-w-lg justify-center rounded-md border-2 border-dashed border-gray-300 px-6 pt-5 pb-6">
                      <div class="space-y-1 text-center">
                        ...
                        <p class="text-xs text-gray-500">.xls, .xlsx, or .csv up to 10MB</p>
                      </div>
                    </div>
                  </section>
                </main>
