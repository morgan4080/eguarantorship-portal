          ...
          <form @submit.prevent="submitMember">
            <div class="shadow sm:overflow-hidden sm:rounded-md">
              <div class="space-y-6 bg-white py-6 px-4 sm:p-6">
                <div>
                  <h3 class="text-lg font-medium leading-6 text-slate-900">Member Information</h3>
                ...
                <div class="grid grid-cols-6 gap-6">
                  ...
                  <div class="col-span-6 sm:col-span-3">
                    <label for="member-number" class="block text-sm font-medium text-slate-700">Member Number</label>
                    <input v-model="form.memberNumber" type="text" name="member-number" id="member-number" class="mt-1 block w-full rounded-md border border-slate-300 py-2 px-3 shadow-sm focus:border-bg-eg focus:outline-none focus:ring-bg-eg sm:text-sm" />
