    ...
    <div class="space-y-6 sm:px-6 lg:px-5">
      <div class="flex justify-between items-center">
        ...
        <div class="flex items-center space-x-4">
          <select v-model="customFilters.loanReqStatus" class="block h-8 mr-5 pl-3 pr-10 text-eg-text bg-gray-200 border-gray-300 focus:outline-none focus:ring-amber-500 focus:border-amber-500 text-xs font-normal rounded-md">
      ...
      <div class="sm:grid sm:grid-cols-4 sm:gap-3">
