...
<!--              <router-link :to="`/profiles/${user.id}`" @click="accountMenu = !accountMenu" class="navbar block px-4 py-2 text-sm text-gray-100 hover:bg-gray-700" role="menuitem" tabindex="-1" id="user-menu-item-0">Your Profile</router-link>-->
    ...
    <div v-if="mobileMenu" class="sm:hidden" id="mobile-menu">
      <div class="px-2 pt-2 pb-3 space-y-1">
        ...
        <a href="#" class="bg-gray-900 text-white block px-3 py-2 rounded-md text-base font-medium" aria-current="page">Requests</a>

        <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-gray-400 block px-3 py-2 rounded-md text-base font-medium">Loans</a>

        <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-gray-400 block px-3 py-2 rounded-md text-base font-medium">Members</a>

        <a href="#" class="text-gray-300 hover:bg-gray-700 hover:text-gray-400 block px-3 py-2 rounded-md text-base font-medium">Settings</a>
      </div>
    </div>
  </nav>
</template>
